        ...
        for name, method in inspect.getmembers(self, predicate=inspect.ismethod):
            if hasattr(method, "_is_tool_action"):
                tool = AutoGeneratedTool(
                    parent=self,
                    method=method,
                    name=getattr(method, "_tool_name", __name__),
...
class AutoGeneratedTool(Tool):
    ...
    def __init__(
        self, parent: Tool, method: Callable, name: str | None = None, description: str | None = None
    ):
        """初始化自动生成的工具
    ...
    def _parse_param_description(self, docstring: str) -> Dict[str, str]:
        ...
        matchs = re.finditer(param_pattern, args_section, re.MULTILINE | re.DOTALL)
